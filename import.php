            ...
            try {
                ...
                for ($i = 1; $i < count($rows); $i++) {
                    ...
                    if (!empty($row[0]) && !empty($row[1]) && !empty($row[2])) {
                        ...
                        $keterangan = mysqli_real_escape_string($conn, $row[1]);
                        $stock = (int)$row[2];
                        $kategori = mysqli_real_escape_string($conn, $row[3]);
                        $harga = !empty($row[4]) ? (int)$row[4] : 0;
                        ...
                        $checkQuery = "SELECT * FROM stock WHERE namabarang = '$namabarang'";
                        $checkResult = mysqli_query($conn, $checkQuery);

                        if (mysqli_num_rows($checkResult) > 0) {
                            // Update stock jika barang sudah ada
                            $updateQuery = "UPDATE stock SET stock = stock + $stock, keterangan = '$keterangan', kategori = '$kategori', harga = $harga, idoutlet = $idoutlet WHERE namabarang = '$namabarang'";
                            ...
                            // Insert barang baru
                            $insertQuery = "INSERT INTO stock (namabarang, keterangan, stock, kategori, harga, idoutlet) VALUES ('$namabarang', '$keterangan', $stock, '$kategori', $harga, $idoutlet)";
...
<head>
    ...
    <title>Import Excel - STOCK BARANG</title>
...
<body>
    <div class="import-container">
        <div class="header-section">
            <h2><i class="fas fa-file-excel"></i> Import Data Stock dari Excel</h2>
            <p>Upload file Excel untuk menambah atau update data stock barang secara batch</p>
        </div>
        ...
        <div class="instructions">
            ...
            <ol>
                ...
                <li><strong>Kolom Opsional:</strong> Kategori, Harga, dan ID Outlet boleh dikosongkan (jika kosong, akan menggunakan outlet user yang login)</li>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="text-center">
                ...
                <a href="stock.php" class="btn btn-secondary btn-lg ml-2">
